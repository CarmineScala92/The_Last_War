...
public class SferaEnergiaRossa extends GestoreImmagini implements Runnable {
	...
	public SferaEnergiaRossa(FinestraGioco p, int x, int y)
	{
		super(new ImageIcon("sferanemico.png").getImage(),x,y);
		this.p=p;
		gestioneThread=true;
		c=new Thread(this);
		c.start();
	...
	//scelgo movimento che deve avere il colpo(ora da destra verso sinistra)
	public void move() 
	{  
		if(super.getX()>10)
